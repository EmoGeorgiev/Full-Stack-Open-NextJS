...
- **Athentication** - Secure login and registration
...
Source code [https://github.com/EmoGeorgiev/Full-Stack-Open-NextJS](https://github.com/EmoGeorgiev/Full-Stack-Open-NextJS )
