...
ALTER TABLE "reading_list" ADD CONSTRAINT "reading_list_blod_id_blogs_id_fk" FOREIGN KEY ("blod_id") REFERENCES "public"."blogs"("id") ON DELETE no action ON UPDATE no action;