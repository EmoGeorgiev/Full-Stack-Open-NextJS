...
Expected: "http://localhost:3000/blogs"
Received: "http://localhost:3000/"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    6 × unexpected value "http://localhost:3000/"
...
- navigation:
  ...
  - link "register":
    - /url: /register
- heading "Welcome to Blog App" [level=1]
- paragraph:
  - text: This is a
  - strong: modern blogging platform
  - text: built with Next.js, featuring user authentication, blog post management, and a clean, intuitive interface.
- heading "Features" [level=1]
- list:
  - listitem:
    - strong: Create and Manage Blogs
    - text: "- Write and publish your thoughts"
  - listitem:
    - strong: User Profiles
    - text: "- Personalized user pages"
  - listitem:
    - strong: Athentication
    - text: "- Secure login and registration"
  - listitem:
    - strong: Comments
    - text: "- Engage with blog posts"
- heading "Getting Started" [level=1]
- paragraph: "To start exploring:"
- list:
  - listitem:
    - link "Register":
      - /url: /register
  ...
  - listitem:
    ...
    - link "users":
      - /url: /users
- paragraph: Built using Next.js, React and Drizzle ORM.
- paragraph:
  - text: Source code
  - link "https://github.com/EmoGeorgiev/Full-Stack-Open-NextJS":
    - /url: https://github.com/EmoGeorgiev/Full-Stack-Open-NextJS
```
